...
export class QueHacerComponent {
  ...
  steps = [
    ...
    {
      icon: Camera, title: '2. Fotografíala', desc: 'Haz una foto del ave y de su entorno. Nos ayuda a identificar la especie y valorar la urgencia.', cls: 'step--educa' },
    { icon: Phone, title: '3. Llámanos', desc: 'Contacta con nosotros lo antes posible. Te intentaremos atender en menos de 24h  y te guiaremos paso a paso.', cls: 'step--divers' },
