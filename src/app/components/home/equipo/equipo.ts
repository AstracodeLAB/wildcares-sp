...
export class EquipoComponent {
  people = [
    ...
    },
    {
      ...
      img: 'assets/equipo/rocio-marquez.jpg',
    },
    {
      name: 'Isabel Alonso',
      role: 'Colaboradora y Consultora estratégica. Colabora en la planificación, organización y desarrollo de acciones para impulsar el crecimiento y sostenibilidad de Wildcares',
      img: 'assets/equipo/IsabelAlonso.jpeg',
    },
    {
      name: 'Raquel Bernard',
      role: 'Social Media',
      img: 'assets/equipo/raquel-bernard.jpeg',
    },
    {
      name: 'Haidée Sariego',
      role: 'Soporte en redacción y justificación de proyectos.',
      img: 'assets/equipo/Haidee.jpeg',
    },
  ];
}
